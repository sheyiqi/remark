...
(defconst customary-better-defaults-packages
  '(
...
(defun customary-better-defaults/init-dired-mode ()
  (use-package dired-mode
    ...
    (progn
      ...
      (defun customary/dired-do-command (command)
...
open and unsaved."
      ...
      (defun customary/dired-up-directory()
      ...
      (evilified-state-evilify-map dired-mode-map
        :mode dired-mode
        :bindings
        (kbd "C-k") 'customary/dired-up-directory
